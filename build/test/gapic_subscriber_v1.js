...
(0, mocha_1.describe)('v1.SubscriberClient', () => {
    ...
    (0, mocha_1.describe)('createSubscription', () => {
        (0, mocha_1.it)('invokes createSubscription without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.Subscription', ['name']);
            ...
            const actualRequest = client.innerApiCalls.createSubscription.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.createSubscription.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes createSubscription without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const promise = new Promise((resolve, reject) => {
                client.createSubscription(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes createSubscription with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes createSubscription with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('getSubscription', () => {
        (0, mocha_1.it)('invokes getSubscription without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.GetSubscriptionRequest', ['subscription']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.getSubscription.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.getSubscription.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes getSubscription without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getSubscription =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.getSubscription(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes getSubscription with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes getSubscription with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('updateSubscription', () => {
        (0, mocha_1.it)('invokes updateSubscription without error', async () => {
            var _a;
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            ...
            (_a = request.subscription) !== null && _a !== void 0 ? _a : (request.subscription = {});
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.UpdateSubscriptionRequest', ['subscription', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.updateSubscription.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.updateSubscription.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes updateSubscription without error using callback', async () => {
            var _a;
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            ...
            client.innerApiCalls.updateSubscription =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.updateSubscription(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes updateSubscription with error', async () => {
            var _a;
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
        ...
        (0, mocha_1.it)('invokes updateSubscription with closed client', async () => {
            var _a;
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
    ...
    (0, mocha_1.describe)('deleteSubscription', () => {
        (0, mocha_1.it)('invokes deleteSubscription without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.DeleteSubscriptionRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.deleteSubscription.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.deleteSubscription.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes deleteSubscription without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteSubscription =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.deleteSubscription(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes deleteSubscription with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes deleteSubscription with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('modifyAckDeadline', () => {
        (0, mocha_1.it)('invokes modifyAckDeadline without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.ModifyAckDeadlineRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.modifyAckDeadline.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.modifyAckDeadline.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes modifyAckDeadline without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.modifyAckDeadline =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.modifyAckDeadline(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes modifyAckDeadline with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes modifyAckDeadline with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('acknowledge', () => {
        (0, mocha_1.it)('invokes acknowledge without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.AcknowledgeRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(new protos.google.protobuf.Empty());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.acknowledge.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.acknowledge.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes acknowledge without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.acknowledge =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.acknowledge(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes acknowledge with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes acknowledge with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('pull', () => {
        (0, mocha_1.it)('invokes pull without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.PullRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.pull.getCall(0)
                .args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.pull.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes pull without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const promise = new Promise((resolve, reject) => {
                client.pull(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes pull with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes pull with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('modifyPushConfig', () => {
        (0, mocha_1.it)('invokes modifyPushConfig without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.modifyPushConfig.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.modifyPushConfig.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes modifyPushConfig without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.modifyPushConfig =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.modifyPushConfig(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes modifyPushConfig with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes modifyPushConfig with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('getSnapshot', () => {
        (0, mocha_1.it)('invokes getSnapshot without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.GetSnapshotRequest', ['snapshot']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.getSnapshot.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.getSnapshot.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes getSnapshot without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.getSnapshot =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.getSnapshot(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes getSnapshot with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes getSnapshot with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('createSnapshot', () => {
        (0, mocha_1.it)('invokes createSnapshot without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.CreateSnapshotRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(new protos.google.pubsub.v1.Snapshot());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.createSnapshot.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.createSnapshot.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes createSnapshot without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.createSnapshot =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.createSnapshot(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes createSnapshot with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes createSnapshot with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('updateSnapshot', () => {
        (0, mocha_1.it)('invokes updateSnapshot without error', async () => {
            var _a;
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            ...
            (_a = request.snapshot) !== null && _a !== void 0 ? _a : (request.snapshot = {});
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.UpdateSnapshotRequest', ['snapshot', 'name']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.updateSnapshot.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.updateSnapshot.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes updateSnapshot without error using callback', async () => {
            var _a;
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            ...
            client.innerApiCalls.updateSnapshot =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.updateSnapshot(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes updateSnapshot with error', async () => {
            var _a;
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
        ...
        (0, mocha_1.it)('invokes updateSnapshot with closed client', async () => {
            var _a;
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
    ...
    (0, mocha_1.describe)('deleteSnapshot', () => {
        (0, mocha_1.it)('invokes deleteSnapshot without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.deleteSnapshot.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.deleteSnapshot.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes deleteSnapshot without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.deleteSnapshot =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.deleteSnapshot(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes deleteSnapshot with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes deleteSnapshot with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('seek', () => {
        (0, mocha_1.it)('invokes seek without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.SeekRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.seek.getCall(0)
                .args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.seek.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes seek without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const promise = new Promise((resolve, reject) => {
                client.seek(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes seek with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes seek with closed client', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('streamingPull', () => {
        (0, mocha_1.it)('invokes streamingPull without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const response = await promise;
            assert.deepStrictEqual(response, expectedResponse);
            assert(client.innerApiCalls.streamingPull
                .getCall(0)
                .calledWith(null));
            assert.deepStrictEqual(stream._transform.getCall(0)
                .args[0], request);
        });
        (0, mocha_1.it)('invokes streamingPull with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('listSubscriptions', () => {
        (0, mocha_1.it)('invokes listSubscriptions without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.ListSubscriptionsRequest', ['project']);
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.listSubscriptions.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.listSubscriptions.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes listSubscriptions without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listSubscriptions =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.listSubscriptions(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes listSubscriptions with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes listSubscriptionsStream without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert(client.descriptors.page.listSubscriptions.createStream
                .getCall(0)
        ...
        (0, mocha_1.it)('invokes listSubscriptionsStream with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('uses async iteration with listSubscriptions without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(client.descriptors.page.listSubscriptions.asyncIterate.getCall(0).args[1], request);
            assert(client.descriptors.page.listSubscriptions.asyncIterate
                .getCall(0)
                .args[2].otherArgs.headers['x-goog-request-params'].includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('uses async iteration with listSubscriptions with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
    ...
    (0, mocha_1.describe)('listSnapshots', () => {
        (0, mocha_1.it)('invokes listSnapshots without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const defaultValue1 = getTypeDefaultValue('.google.pubsub.v1.ListSnapshotsRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = [
            ...
            assert.deepStrictEqual(response, expectedResponse);
            const actualRequest = client.innerApiCalls.listSnapshots.getCall(0).args[0];
            assert.deepStrictEqual(actualRequest, request);
            const actualHeaderRequestParams = client.innerApiCalls.listSnapshots.getCall(0).args[1].otherArgs.headers['x-goog-request-params'];
            assert(actualHeaderRequestParams.includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('invokes listSnapshots without error using callback', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            client.innerApiCalls.listSnapshots =
                stubSimpleCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                client.listSnapshots(request, (err, result) => {
                    if (err) {
                        reject(err);
                    }
                    else {
        ...
        (0, mocha_1.it)('invokes listSnapshots with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('invokes listSnapshotsStream without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            const responses = await promise;
            assert.deepStrictEqual(responses, expectedResponse);
            assert(client.descriptors.page.listSnapshots.createStream
                .getCall(0)
        ...
        (0, mocha_1.it)('invokes listSnapshotsStream with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
        ...
        (0, mocha_1.it)('uses async iteration with listSnapshots without error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
            ...
            assert.deepStrictEqual(responses, expectedResponse);
            assert.deepStrictEqual(client.descriptors.page.listSnapshots.asyncIterate.getCall(0).args[1], request);
            assert(client.descriptors.page.listSnapshots.asyncIterate
                .getCall(0)
                .args[2].otherArgs.headers['x-goog-request-params'].includes(expectedHeaderRequestParams));
        });
        (0, mocha_1.it)('uses async iteration with listSnapshots with error', async () => {
            const client = new subscriberModule.v1.SubscriberClient({
                credentials: { client_email: 'bogus', private_key: 'bogus' },
                projectId: 'bogus',
            });
...
//# sourceMappingURL=gapic_subscriber_v1.js.map