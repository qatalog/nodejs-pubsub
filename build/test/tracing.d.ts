 ...
 */
import { BasicTracerProvider, InMemorySpanExporter } from '@opentelemetry/tracing';
/**
 ...
 */
export declare const exporter: InMemorySpanExporter;
export declare const provider: BasicTracerProvider;
